...
export class DatabaseService {
   ...
   // private _loginUrl="https://3tkxmc5luk.execute-api.us-east-1.amazonaws.com/dev/admin/validateLogin"
    private AddQuiz_URL = 'https://3tkxmc5luk.execute-api.us-east-1.amazonaws.com/dev/admin/admJoshua/createQuiz';
    ...
    CreateQuiz(title, description) {
     ...
     return this.http.post(this.AddQuiz_URL, body, options).map((res: Response) => res.json());
